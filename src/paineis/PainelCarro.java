...
public class PainelCarro extends javax.swing.JPanel {
    ...
    private JCheckBox jcbCheck,jcbCheck2,jcbCheck3;
    ...
    private void iniciarComponentes() {
        //JCOMBOBOX
        String[] tipos = {"Hatch","Sedã","SUV","Picapes","Minivan","Esportivo"};
        jcbCaixinha = new JComboBox(tipos);
        add(jcbCaixinha);
        jcbCaixinha.setBounds(650,40,150,30);
        jlTipo = new JLabel("Tipo do Veiculo"); add(jlTipo);
        jlTipo.setBounds(650,20,150,20);

        //CHECKBOX
        jcbCheck = new JCheckBox("4 Lugares");
        jcbCheck2 = new JCheckBox("5 Lugares");
        jcbCheck3 = new JCheckBox("7 Lugares");

        add(jcbCheck);
        add(jcbCheck2);
        add(jcbCheck3);

        jcbCheck.setBounds(650,130,150,20);
        jcbCheck2.setBounds(650,160,150,20);
        jcbCheck3.setBounds(650,190,150,20);
